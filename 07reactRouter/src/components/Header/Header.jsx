// we don't use anchor tag because it refreshes the whole app or DOM, which defeats the whole 
// purpose of react. So we use Link. 
// We use NavLink as it provides some extra attributes.
            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    >
                        ...
                        lg:mt-0">
                            <li>
                        {/* we are passing className using a callback func because in this way, by
                        default NavLink provides isPending, isActive, etc attributes/variables */}
                        {/* We are using to in NavLink to different route to them  */}
